    ...
    <v-form @submit="handleSubmit">
        <div class="mb-3">
            ...
            <v-field id="name" v-model="formData.name" type="text" class="form-control" name="name"
                :rules="formDataSchema.name" :disabled="!conEdit"></v-field>
        ...
        <div class="mb-3">
            ...
            <v-field id="phone" v-model="formData.phone" type="text" class="form-control" name="phone"
                :rules="formDataSchema.phone" :disabled="!conEdit"></v-field>
        ...
        <div class="mb-3">
            ...
            <v-field id="address" v-model="formData.address" type="text" class="form-control" name="address"
                :rules="formDataSchema.address" :disabled="!conEdit"></v-field>
            <error-message name="address" class="text-danger"></error-message>
        </div>

        <div class="mb-3">
            <label for="introduce" class="form-label">店家描述</label>
            <v-field id="introduce" v-model="formData.introduce" as="textarea" class="form-control"
                style="min-height: 100px; max-height: 200px" name="introduce" :rules="formDataSchema.introduce"
                :disabled="!conEdit"></v-field>
            <error-message name="introduce" class="text-danger"></error-message>
        </div>
        <div class="mb-3">
            <label for="avatar" class="form-label">上傳頭像</label>
            <div class="mb-2">
                <img v-if="formData.avatar" width="54" :src="formData.avatar" alt="店家頭像" />
            </div>

            <input id="avatar" type="file" class="form-control" name="avatar" :rules="formDataSchema.avatar"
                :disabled="!conEdit" @change="handleFileUpload" />
