        ...
        <div class="row py-3 justify-content-center">
            <div class="col-8 bg-white py-3 px-5 border rounded-3 noto-serif-tc lh-lg">
                ...
                <div class="py-4 fw-bold lh-lg w-80">
                    ...
                    <hr />
                    <p class="text-grey66">
                        <span style="width: 80px" class="d-inline-block text-black">備註</span>{{ formData.notes }}
                    </p>
                    <hr />
                    <p class="text-danger">
                ...
                <div class="d-flex justify-content-center pb-4 gap-3">
                    <button type="button" class="fw-bold btn btn-outline-primary" @click="goBack">
                    ...
                    <button class="btn btn-primary fw-bold px-4" @click="payment">
                        完成結帳
                    </button>
                </div>
            </div>
